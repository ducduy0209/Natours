...
},{}],"logged.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHVjZHV5MDIwOSIsImEiOiJjbDY3cjJ3bDgwMG8zM2pwZThveWg3bjU0In0.l5jczL3oXIuEcbk5yojq1A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ducduy0209/cl051wta0000d14moh68wvwyw',
    scrollZoom: false // center: [-118.113419, 34.111745],
    // zoom: 10,
    // interactive: false
...
var stripe = Stripe('pk_test_51KYsxPCm0Lpr2MHlj2A7yBKAq9sgzqUzybCAFQUXTe3pKvKG3VUX08KTK32jy1NbKtgUVFPPEfMbCQmBOANJR14k007NwPVhhG');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signup successfully! Please check your email to active your account');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{}],"forgotAndReset.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Please check your email to reset your password!');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Reset your password successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","../../utils/catchAsync":"../../utils/catchAsync.js","./alerts":"alerts.js"}],"handleReviewModel.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.hideModel = exports.handleRangtings = void 0;

/* eslint-disable */
var handleRangtings = function handleRangtings() {
  var increaseBtn = document.querySelector('#add');
  var reduceBtn = document.querySelector('#subtract');
  var inputRatings = document.querySelector('#review-rating');
...
exports.handleRangtings = handleRangtings;

var hideModel = function hideModel() {
  var closeBtn = document.querySelector('.close__review');
  var overlay = document.querySelector('.model-review__overlay');
...
exports.handleReviewTour = exports.deleteReviewTour = void 0;
...
var reviewTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, id, type) {
    var method, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = type === 'create' ? "/api/v1/tours/".concat(id, "/reviews") : "/api/v1/reviews/".concat(id);
            _context.next = 5;
            return (0, _axios.default)({
              method: method,
              url: url,
          ...
          case 5:
            ...
            if (type === 'create') {
              if (res.data.status === 'success') {
                (0, _alerts.showAlert)('success', 'Review tour successfully');
                window.setTimeout(function () {
              ...
              if (res.data.status === 'success') {
                (0, _alerts.showAlert)('success', 'Edit review tour successfully');
                window.setTimeout(function () {
                  location.reload(true);
                }, 1200);
              }
          ...
          case 9:
            ...
            if (_context.t0.response.data.message.indexOf('duplicate') > -1) {
              (0, _alerts.showAlert)('error', 'You can only review one tour one time.');
            } else {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message);
            }
...
var handleReviewTour = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            id = type === 'create' ? document.querySelector('.btn--review').dataset.tourIdReview : document.querySelector('.btn--review').dataset.reviewId;
  ...
  return function handleReviewTour(_x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.handleReviewTour = handleReviewTour;

var deleteReviewTour = /*#__PURE__*/function () {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.length === 0) {
              (0, _alerts.showAlert)('success', 'Delete review tour successfully');
              window.setTimeout(function () {
                location.reload(true);
              }, 1200);
            }
  ...
  return function deleteReviewTour(_x5) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteReviewTour = deleteReviewTour;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"handleLikeTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.openLoading = exports.handleLikeTourBrowser = exports.closeLoading = void 0;
...
var handleLikeTourAPI = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
  ...
  return function handleLikeTourAPI(_x) {
    return _ref.apply(this, arguments);
  };
}();

var openLoading = function openLoading(type) {
  if (type === 'like') {
...
var closeLoading = function closeLoading(type) {
  if (type === 'like') {
    ...
    document.querySelector('.description__heart').textContent = 'Click to remove from your favorites';
  ...
  if (type === 'liked') {
    ...
    document.querySelector('.description__heart').textContent = 'Click to add to your favorites';
    document.querySelector('.circle-loading').classList.add('hide');
  }
};
...
var handleLikeTourBrowser = function handleLikeTourBrowser(btn, type) {
  document.querySelector('.description__heart').textContent = type === 'liked' ? 'Click to remove from your favorites' : 'Click to add to your favorites';
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              openLoading(type);
              _context2.next = 4;
              return handleLikeTourAPI(tourId);
...
exports.handleLikeTourBrowser = handleLikeTourBrowser;
...
var searchTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(text) {
    var textCovert, res, ulElemnt, b;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            textCovert = text.split(' ').join('-');
            _context.next = 4;
            return (0, _axios.default)({
              method: 'get',
              url: "/api/v1/tours/search/".concat(textCovert, "}")
            });
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              document.querySelector('.results__search .description p span').textContent = res.data.results;
              ulElemnt = document.querySelector('.results__search');
              b = res.data.data.tours.map(function (tour) {
                return "\n            <li class=\"result__item\">\n            <img src='/img/tours/".concat(tour.imageCover, "' alt=\"Image cover of this tour\"/>\n            <a class=\"result__item-link\" href='/tour/").concat(tour.slug, "'>").concat(tour.name, "</a>\n            </li>\n            ");
              });
  ...
  return function searchTour(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.searchTour = searchTour;
...
var _forgotAndReset = require("./forgotAndReset");

var _handleReviewModel = require("./handleReviewModel");

var _review = require("./review");

var _handleLikeTour = require("./handleLikeTour");
...
var $$ = document.querySelectorAll.bind(document); // DOM ELEMENTS

var loginForm = $('.form.form--login');
var mapBox = $('#map');
var logoutBtn = $('.nav__el--loggout');
var userDataForm = $('.form-user-data');
var userPasswordForm = $('.form-user-settings');
var bookTourBtn = $('#book-tour');
var notifyConfirmEmail = $('.notification__confirm-email');
var signupForm = $('.form.form--signup');
var forgotForm = $('.form.form--forgot');
var resetForm = $('.form.form--reset');
var reviewPopup = $('.btn.btn__review-popup');
var reviewForm = $('.form.form--review');
var likedTourBtn = $('.heart--icon__liked.active');
var likeTourBtn = $('.heart--icon.active');
var editReviewBtn = $$('.review__edit-icon');
var deleteReviewBtnsPopup = $$('.review__trash-icon');
var deleteReviewForm = $('.model__deleteReview-form');
var deleteReviewBtn = $('.model__deleteReview-btn-delete');
var cancelReviewDeleteBtn = $('.model__deleteReview-btn-cancel');
var inputSearchTour = $('.nav__search-input');
var listResultsSearch = $('.results__search');
var navSearch = $('.nav__search');
var typingTimer; // DELEGATION

if (mapBox) {
  var locations = JSON.parse(mapBox.getAttribute('data-locations'));
  (0, _mapbox.displayMap)(locations);
}

navSearch.addEventListener('submit', /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (listResultsSearch.children.length > 1) {
              for (i = 1; i < listResultsSearch.children.length; i++) {
            ...
            _context.next = 6;
            return (0, _search.searchTour)(inputSearchTour.value);
...
inputSearchTour.addEventListener('blur', function () {
  setTimeout(function () {
    listResultsSearch.style.display = 'none';
  }, 10);
});
inputSearchTour.addEventListener('input', function () {
  listResultsSearch.style.display = 'none';
});
inputSearchTour.addEventListener('focus', function () {
  if (inputSearchTour.value !== '' && listResultsSearch.children.length > 1) listResultsSearch.style.display = 'block';
});
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return (0, _logged.login)(email, password);
...
if (logoutBtn) logoutBtn.addEventListener('click', _logged.logout);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            passwordCurrent = $('#password-current').value;
            password = $('#password').value;
            passwordConfirm = $('#password-confirm').value;
            _context5.next = 7;
...
if (notifyConfirmEmail) window.setTimeout(function () {
  location.assign('/');
}, 3000);
if (forgotForm) forgotForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 5;
            return (0, _forgotAndReset.forgotPassword)(email);
...
if (resetForm) resetForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 6;
            return (0, _forgotAndReset.resetPassword)(password, passwordConfirm);
...
if (editReviewBtn) {
  var _iterator = _createForOfIteratorHelper(editReviewBtn),
      _step;
...
if (deleteReviewBtnsPopup) {
  var _iterator2 = _createForOfIteratorHelper(deleteReviewBtnsPopup),
      _step2;
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      _btn.addEventListener('click', function (e) {
        $('.model__deleteReview-btn-delete').dataset.reviewId = e.target.dataset.reviewIdDelete;
...
if (deleteReviewForm) {
  deleteReviewForm.addEventListener('submit', function (e) {
    e.preventDefault();
  });
  ...
  cancelReviewDeleteBtn.addEventListener('click', function () {
    $('.model__deleteReview').classList.remove('open');
  });
  $('.model__deleteReview-overlay').addEventListener('click', function () {
    $('.model__deleteReview').classList.remove('open');
  });
}

if (reviewPopup) reviewPopup.addEventListener('click', function () {
  $('.model__review').classList.add('open');
});

if (reviewForm) {
  (0, _handleReviewModel.handleRangtings)();
  (0, _handleReviewModel.hideModel)();
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              console.log('hi');
              _context9.next = 5;
              return (0, _review.handleReviewTour)('edit');
            ...
            case 7:
              console.log('hello');
              _context9.next = 10;
              return (0, _review.handleReviewTour)('create');
