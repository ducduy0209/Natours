    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? 'http://localhost:8080/api/v1/users/updateMe' : 'http://localhost:8080/api/v1/users/updateMyPassword';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'patch',
              url: url,
...
var logoutBtn = document.querySelector('.nav__el--loggout');
...
var notifyConfirmEmail = document.querySelector('.notification__confirm-email');
var signupForm = document.querySelector('.form.form--signup');
var forgotForm = document.querySelector('.form.form--forgot');
var resetForm = document.querySelector('.form.form--reset'); // DELEGATION
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            form.append('photo', document.getElementById('photo').files[0] || 'default.jpg');
